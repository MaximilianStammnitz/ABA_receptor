...
PYL1_minimum_ABA_ABI1_distances_from_PDB <- function(input_file, PYL1_chain_query, ABI1_chain_query, ABA_query){
  ...
  sele_H <- atom.select(PYL1.ABI1.pdb,
                        string = "h",
                        verbose = FALSE)
...
PYL1_ABA_ABI1_dist <- PYL1_minimum_ABA_ABI1_distances_from_PDB(input_file = "../../data/PDB/original/Yin_2009_ABA-PYL1-ABI1/pdb3kdj.ent",
                                                               PYL1_chain_query = "A",
                                                               ABI1_chain_query = "B",
                                                               ABA_query = "A8S")
...
# [1] data.table_1.17.8 bio3d_2.4-5      
# 
# loaded via a namespace (and not attached):
# [1] compiler_4.5.1 parallel_4.5.1 tools_4.5.1    Rcpp_1.1.0     grid_4.5.1