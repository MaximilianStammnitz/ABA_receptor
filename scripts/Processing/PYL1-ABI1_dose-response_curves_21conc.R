...
pdf("../../results/All_PYL1-ABI1_dose-response_curves_21conc.pdf", height = 15, width = 18)
...
for(i in 1:nrow(parameters.Hill)){
  ...
  if(skip_to_next == T) {
    ...
    tmp.PYL1.drc.Hill.predict.newdata <- expand.grid(conc = c(0, exp(seq(log(0.00001), log(5000), length = 999))))
    ...
    ### plot curve
    drc.summary.tmp$concentration[21] <- 6.87194767360001e-05/2.5/2.5/2.5 ## "0-conc." positioning for log scale
...
save(parameters.Hill, file = "../../data/DRCs/PYL1-ABI1_parameters_Hill_21conc.RData")
...
# [1] rlang_1.1.6   cowplot_1.2.0 ggtext_0.1.2  ggplot2_4.0.0 drc_3.0-1     MASS_7.3-65   scales_1.4.0  stringr_1.5.2
# 
