...
###########################################################
## Extended Data Figure 5A - PYL1-PYL1 TECAN validations ##
###########################################################
...
pdf("../../results/FigureED5/FigureED5A_abundancePCA_validation.pdf", height = 15, width = 18)
...
out.S5A <- ggplot(out.all, aes(x = `tecan_mean`, y = `bulk_mean`)) +
  ...
  labs(x = "Relative PYL1 Abundance (individual mutants, AUC)",
       y = "Relative PYL1 Abundance (library sequencing)")
...
# [1] rlang_1.1.6        ggtext_0.1.2       ggplot2_4.0.0      reshape_0.8.10     scales_1.4.0       growthcurver_0.3.1 readxl_1.4.5       stringr_1.5.2     
#
# loaded via a namespace (and not attached):
# [1] Matrix_1.7-4       gtable_0.3.6       dplyr_1.1.4        compiler_4.5.1     crayon_1.5.3       tidyselect_1.2.1   Rcpp_1.1.0         minpack.lm_1.2-4   xml2_1.4.0         splines_4.5.1     
# [11] lattice_0.22-7     R6_2.6.1           plyr_1.8.9         generics_0.1.4     tibble_3.3.0       pillar_1.11.1      RColorBrewer_1.1-3 stringi_1.8.7      S7_0.2.0           cli_3.6.5         
# [21] withr_3.0.2        magrittr_2.0.4     mgcv_1.9-3         grid_4.5.1         gridtext_0.1.5     nlme_3.1-168       lifecycle_1.0.4    vctrs_0.6.5        glue_1.8.0         farver_2.1.2      
# [31] cellranger_1.1.0   tools_4.5.1        pkgconfig_2.0.3  