...
grad_colors <- alpha(colorRampPalette(c("white", "darkgreen"))(12), 0.8)
...
out.1G <- ggplot(plot_data, aes(x = x, y = y, group = group, fill = dosage)) +
  ...
  labs(x = "Relative PYL1/ABI1 Binding", y = "")
...
# [1] crayon_1.5.3       vctrs_0.6.5        cli_3.6.5          rlang_1.1.6        stringi_1.8.7      generics_0.1.4     S7_0.2.0           labeling_0.4.3     glue_1.8.0         gridtext_0.1.5    
