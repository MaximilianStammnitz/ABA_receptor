...
## clean up
rm(PYL1.ABI1.TECAN.plate1, coefs, setup1,
   i, k, tmp.out, WT.PYL1.drc.1, WT.PYL1.drc.1.par)
...
out.tecan.df <- cbind("conc" = rep(1:12, nrow(parameters.Hill.lib.hq)),
                      "tecan mean" = TECAN, 
...
# [1] rlang_1.1.6        ggtext_0.1.2       ggplot2_4.0.0      drc_3.0-1          MASS_7.3-65        reshape_0.8.10     growthcurver_0.3.1 readxl_1.4.5      
# 
# loaded via a namespace (and not attached):
# [1] sandwich_3.1-1     generics_0.1.4     xml2_1.4.0         gtools_3.9.5       lattice_0.22-7     magrittr_2.0.4     grid_4.5.1         RColorBrewer_1.1-3 mvtnorm_1.3-3      cellranger_1.1.0  
# [11] plyr_1.8.9         Matrix_1.7-4       Formula_1.2-5      survival_3.8-3     multcomp_1.4-28    mgcv_1.9-3         scales_1.4.0       TH.data_1.1-4      codetools_0.2-20   abind_1.4-8       
# [21] cli_3.6.5          crayon_1.5.3       splines_4.5.1      withr_3.0.2        plotrix_3.8-4      tools_4.5.1        minpack.lm_1.2-4   dplyr_1.1.4        vctrs_0.6.5        R6_2.6.1          
# [31] zoo_1.8-14         lifecycle_1.0.4    car_3.1-3          pkgconfig_2.0.3    pillar_1.11.1      gtable_0.3.6       glue_1.8.0         Rcpp_1.1.0         tibble_3.3.0       tidyselect_1.2.1  
# [41] farver_2.1.2       nlme_3.1-168       labeling_0.4.3     carData_3.0-5      compiler_4.5.1     S7_0.2.0           gridtext_0.1.5 