...
##################################################################
## Extended Data Figure 6A - aPCA residual outliers (example 5) ##
##################################################################
...
## EC50
EC50.res <- c("L196", "H87", "K200", "E171", "Y50")
...
## plot all
pdf('../../results/FigureED6/FigureED6A_Hill_paramater_residuals_example5.pdf', width = 60, height = 42)
...
# [1] cowplot_1.2.0  ggrepel_0.9.6  ggtext_0.1.2   ggplot2_4.0.0  reshape_0.8.10 scales_1.4.0   stringr_1.5.2  readxl_1.4.5  
# 
# loaded via a namespace (and not attached):
# [1] gtable_0.3.6       dplyr_1.1.4        compiler_4.5.1     tidyselect_1.2.1   Rcpp_1.1.0         xml2_1.4.0         R6_2.6.1           plyr_1.8.9         commonmark_2.0.0   labeling_0.4.3    
# [11] generics_0.1.4     tibble_3.3.0       pillar_1.11.1      RColorBrewer_1.1-3 rlang_1.1.6        stringi_1.8.7      xfun_0.53          litedown_0.7       S7_0.2.0           cli_3.6.5         
# [21] withr_3.0.2        magrittr_2.0.4     grid_4.5.1         gridtext_0.1.5     markdown_2.0       lifecycle_1.0.4    vctrs_0.6.5        glue_1.8.0         farver_2.1.2       cellranger_1.1.0  
# [31] tools_4.5.1        pkgconfig_2.0.3  