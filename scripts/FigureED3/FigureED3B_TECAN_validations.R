...
####################################################################
## Extended Data Figure 3B - PYL1-ABI1 Hill parameter validations ##
####################################################################
...
## combined plot
pdf("../../results/FigureED3/FigureED3B_Hill_parameter_validation.pdf", height = 15, width = 55)
...
# [1] rlang_1.1.6        cowplot_1.2.0      ggtext_0.1.2       ggplot2_4.0.0      reshape_0.8.10     scales_1.4.0       drc_3.0-1          MASS_7.3-65        growthcurver_0.3.1 readxl_1.4.5      
# [11] stringr_1.5.2     
# 
...
# [21] crayon_1.5.3       splines_4.5.1      withr_3.0.2        plotrix_3.8-4      tools_4.5.1        minpack.lm_1.2-4   dplyr_1.1.4        vctrs_0.6.5        R6_2.6.1           zoo_1.8-14        
# [31] lifecycle_1.0.4    car_3.1-3          pkgconfig_2.0.3    pillar_1.11.