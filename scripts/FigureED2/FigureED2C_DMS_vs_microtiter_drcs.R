...
###################################################################################
## Extended Data Figure 2C - DMS vs. microtiter plate based dose-response curves ##
###################################################################################
...
drc.plot.microtiter <- function(curves, datapoints, variant){
  ...
  ggplot(curves, aes(x = concentration, y = Prediction)) +
    ...
    theme(plot.title = element_markdown(),
          ...
          plot.margin = unit(c(2, 2, 2, 2),"cm")) +
    labs(x = "(+)-ABA concentration (µM)",
         y = "Relative PYL1/ABI1 Binding (individual mutant)")
  
}

pdf("../../results/FigureED2/FigureED2C_curves_microtiter_vs_DMS.pdf", height = 30, width = 100)
...
grid.arrange(drc.plot.DMS(PYL1.ABI1.DMS.curves, PYL1.ABI1.keyvars, "WT"), 
             ...
             drc.plot.microtiter(PYL1.TECAN.curves.auc.predict, PYL1.ABI1.TECAN.plate1.curves.auc, "WT"), 
...
# [1] gridExtra_2.3      rlang_1.1.6        ggtext_0.1.2       ggplot2_4.0.0      scales_1.4.0       drc_3.0-1          MASS_7.3-65        reshape_0.8.10     growthcurver_0.3.1 readxl_1.4.5      
# 
# loaded via a namespace (and not attached):
# [1] sandwich_3.1-1     generics_0.1.4     xml2_1.4.0         gtools_3.9.5       lattice_0.22-7     magrittr_2.0.4     RColorBrewer_1.1-3 mvtnorm_1.3-3      cellranger_1.1.0   plyr_1.8.9        
# [11] Matrix_1.7-4       Formula_1.2-5      survival_3.8-3     multcomp_1.4-28    TH.data_1.1-4      codetools_0.2-20   abind_1.4-8        cli_3.6.5          crayon_1.5.3       splines_4.5.1     
# [21] withr_3.0.2        plotrix_3.8-4      tools_4.5.1        minpack.lm_1.2-4   dplyr_1.1.4        vctrs_0.6.5        R6_2.6.1           zoo_1.8-14         lifecycle_1.0.4    car_3.1-3         
# [31] pkgconfig_2.0.3    pillar_1.11.1      gtable_0.3.6       glue_1.8.0         Rcpp_1.1.0         tibble_3.3.0       tidyselect_1.2.1   farver_2.1.2       carData_3.0-5      compiler_4.5.1    
# [41] S7_0.2.0           gridtext_0.1.5 