...
############################################################################
## Extended Data Figure 2D - Potency shift of (+)-ABA GluePCA vs in vitro ##
############################################################################
...
## correlate
out.cor <- cbind("conc" = c(0, exp(seq(log(0.001), log(5000), length = 999))), 
                 "corr" = rep(NA,1000))
for(i in 1:1000){
...
## ggPlots
pdf("../../results/FigureED2/FigureED2D_potency_shift.pdf", height = 15, width = 1.130682*18)
...
pdf("../../results/FigureED2/FigureED2D_potency_shift_obs.pdf", height = 15, width = 18)
print(out.S2D_obs)
dev.off()
...
pdf("../../results/FigureED2/FigureED2D_potency_shift_theor_max.pdf", height = 15, width = 18)
...
# [11] splines_4.5.1      scales_1.4.0       lattice_0.22-7     TH.data_1.1-4      R6_2.6.1           generics_0.1.4     Formula_1.2-5      tibble_3.3.0       car_3.1-3          pillar_1.11.1     
# [21] RColorBrewer_1.1-3 multcomp_1.4-28    S7_0.2.0           cli_3.6.5          mgcv_1.9-3         withr_3.0.2        magrittr_2.0.4     gridtext_0.1.5     grid_4.5.1         mvtnorm_1.3-3     
# [31] sandwich_3.1-1     nlme_3.1-168       lifecycle_1.0.4    vctrs_0.6.5        glue_1.8.0         farver_2.1.2       codetools_0.2-20   zoo_1.8-14         survival_3.8-3     abind_1.4-8       
# [41] carData_3.0-5      tools_4.5.1        pkgconfig_2.0.3   