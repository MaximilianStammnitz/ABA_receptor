...
#######################################################
## Extended Data Figure 1 - GluePCA TECAN benchmarks ##
#######################################################
...
## Libraries
packages <- c("readxl", "growthrates", "drc")
...
## PYL1-ABI1
pdf("../../results/FigureED1/FigureED1A_GluePCA_benchmark_PYL1-ABI1.pdf", width = 15, height = 8)
...
## GID1A-GAI ##
pdf("../../results/FigureED1/FigureED1B_GluePCA_benchmark_GID1A-GAI.pdf", width = 15, height = 8)
par(mar = c(6,8,3,0.5), mfrow = c(1,2))
...
## FKBP12-FRB ##
pdf("../../results/FigureED1/FigureED1C_GluePCA_benchmark_FRB-FKBP12.pdf", width = 15, height = 8)
par(mar = c(6,8,3,0.5), mfrow = c(1,2))
...
# [1] drc_3.0-1         MASS_7.3-65       growthrates_0.8.5 deSolve_1.40      lattice_0.22-7    readxl_1.4.5     
# 
# loaded via a namespace (and not attached):
# [1] Matrix_1.7-4       compiler_4.5.1     gtools_3.9.5       plotrix_3.8-4      Rcpp_1.1.0         minpack.lm_1.2-4   parallel_4.5.1     splines_4.5.1      scales_1.4.0       coda_0.19-4.1     
# [11] TH.data_1.1-4      R6_2.6.1           Formula_1.2-5      tibble_3.3.0       car_3.1-3          minqa_1.2.8        pillar_1.11.1      RColorBrewer_1.1-3 rlang_1.1.6        multcomp_1.4-28   
# [21] cli_3.6.5          FME_1.3.6.4        magrittr_2.0.4     grid_4.5.1         mvtnorm_1.3-3      rootSolve_1.8.2.4  sandwich_3.1-1     lifecycle_1.0.4    vctrs_0.6.5        glue_1.8.0        
# [31] farver_2.1.2       cellranger_1.1.0   codetools_0.2-20   zoo_1.8-14         survival_3.8-3     abind_1.4-8        carData_3.0-5      pkgconfig_2.0.3    tools_4.5.1